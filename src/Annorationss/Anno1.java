 ...
 */
public class Anno1 {
    /*Classes, methods, variables, parameters and packages are allowed to be annotated.*/
    /*An annotation is a marker which associates information with a program construct, but has no effect at run time.*/
  /*  Annotations are used for a multitude of purposes. Frameworks like Spring and Spring-MVC make use of annotations
